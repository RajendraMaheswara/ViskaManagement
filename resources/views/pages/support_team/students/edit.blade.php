                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->email  }}" type="email" name="email" class="form-control" placeholder="test@email.com">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select required data-placeholder="Pilih Kabupaten" class="select-search form-control" name="lga_id" id="lga_id">
                                @if($sr->user->lga_id)
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="bg_id" name="bg_id" data-fouc data-placeholder="Pilh ...">
                                    <option value=""></option>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select data-placeholder="Pilih ....."  name="dorm_id" id="dorm_id" class="select-search form-control">
                                <option value=""></option>
                                @foreach($dorms as $d)
