                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="dob" value="{{ old('dob') }}" type="text" class="form-control date-pick" placeholder="Pilih Tanggal Lahir">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="bg_id" name="bg_id" data-fouc data-placeholder="Pilih Golongan Darah">
                                    <option value=""></option>
